...
# Actual Description	: A simple Tkinter app to detect ab combinations
# ========================================================================
# HEADERS
# ========================================================================
...
def detect_a_b(a_b_input:str = "") -> bool:
	count_a:int = a_b_input.count('a')
	count_b:int = a_b_input.count('b')
...
def button_function(input_box: tk.Entry, output_box: tk.Text) -> None:
	...
	output_text = "YES" if detect_a_b(input_text) else "NO"
